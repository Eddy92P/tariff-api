...
function ModalAgregarArquitecto(props) {
  ...
  useEffect(() => {
    ...
    setMessageText(
      props.editArquitecto
        ...
        : ' El Arquitecto fue agregado exitosamente.'
    );
  }, [props]);
  return (
    <Dialog onClose={handleClose} open={open} fullScreen={fullScreen}>
      ...
      <DialogTitle style={{ textAlign: 'center' }}>
        Arquitecto {descriptionText} exitosamente.
      </DialogTitle>
      <DialogContent>
...
export default ModalAgregarArquitecto;
